...
| 6 | `instruction.md` was vague prose with no output path, no schema, no success criteria | Rewrote with the absolute path, exact JSON schema, and 4 numbered criteria matching the verifier 1:1 |
